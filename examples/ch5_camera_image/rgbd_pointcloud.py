"""Back-project one RGB-D image pair into an ASCII PLY point cloud."""
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--depth", required=True, type=Path, help="Path to an aligned depth image.")
...
def main() -> None:
    ...
    cloud = rgbd_to_point_cloud(
        _read_color(args.color),
        _read_depth(args.depth),
        intrinsics,
