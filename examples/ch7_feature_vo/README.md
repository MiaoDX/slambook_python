...
```bash
uv run python examples/ch7_feature_vo/triangulation.py \
  --image0 data/slambook/ch7/1.png \
  --image1 data/slambook/ch7/2.png \
  --matcher orb \
  --intrinsics 520.9 521.0 325.1 249.7 \
...
```bash
uv run python examples/ch7_feature_vo/compare_matchers.py \
  --image0 data/slambook/ch7/1.png \
  --image1 data/slambook/ch7/2.png \
...
```bash
uv run python examples/ch7_feature_vo/pose_estimation_3d2d.py \
  --image0 data/slambook/ch7/1.png \
  --image1 data/slambook/ch7/2.png \
...
```bash
uv run python examples/ch7_feature_vo/pose_estimation_3d3d.py \
  --image0 data/slambook/ch7/1.png \
  --image1 data/slambook/ch7/2.png \
  --depth0 data/slambook/ch7/1_depth.png \
