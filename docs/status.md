...
| ch10 | Bundle adjustment | In progress | SciPy | GTSAM/PyCOLMAP | BAL parser, `scipy_ba` module, SciPy CLI, PyCOLMAP reference guard, and optional backend guards added |
| ch11 | Pose graph | In progress | SciPy small graph | GTSAM | g2o parser, included tiny fixture, SciPy optimizer, CLI trajectory export, Matplotlib plot export, optional Rerun logging, and GTSAM guard added |
